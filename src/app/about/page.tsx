                ...
                <div className="max-w-7xl mx-auto">
                    <div className="max-w-3xl">
                        ...
                        <h1 className="text-4xl md:text-6xl font-extrabold text-stone-900 mb-8 leading-tight font-marathi">
                            शुभारंभ – <br />
                            <span className="text-primary italic text-3xl md:text-4xl">By Radix International</span>
                        </h1>
                        <p className="text-xl text-stone-600 leading-relaxed mb-6">
                            पुणे आणि महाराष्ट्र परिसरातील शेतकऱ्यांच्या समस्यांना जैविक उत्तर देण्यासाठी आम्ही 'Radix International - शुभारंभ' तर्फे काम करतो. आमच्या मार्गदर्शनाखाली शेकडो डाळिंब व पेरूच्या बागा आज यशस्वीरीत्या बहरत आहेत.
                        </p>
                    </div>
                </div>
            </section>
